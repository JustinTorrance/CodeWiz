const categories = {
  "scopeQuestions": [{
    ...
    {
      "question": "True or false: Scopes can also be layered in a hierarchy, so that child scopes have access to parent scopes, but not vice versa.",
      "answers": [{
          "answer": "True",
          "isTrue": true
        },
